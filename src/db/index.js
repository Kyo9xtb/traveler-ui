        ...
        const fetchAllData = async () => {
            const fetchTours = async () => {
                try {
                    ...
                    res.length ? setListTours(res) : setListTours(tourStaticData);
                } catch (err) {
            ...
            const fetchDestinations = async () => {
                try {
                    ...
                    res.length ? setListDestinations(res) : setListDestinations(touristPlaceStaticData);
                } catch (err) {
            ...
            const fetchNews = async () => {
                try {
                    ...
                    res.length ? setListNews(res) : setListNews(newsStaticData);
                } catch (err) {
